import { FlipMode, ImageSource, MimeType, PhotoBatchOperations, Point, Rect, RotationMode, Size, TextOptions } from './PhotoManipulatorTypes';
export interface PhotoManipulatorStatic {
     ...
     * @param mimeType (optional) Mimetype of output image (image/jpeg, image/png)
     */
    flipImage: (image: ImageSource, mode: FlipMode, mimeType?: MimeType) => Promise<string>;
    /**
     ...
     * @param mimeType (optional) Mimetype of output image (image/jpeg, image/png)
     */
    rotateImage: (image: ImageSource, mode: RotationMode, mimeType?: MimeType) => Promise<string>;
    /**
